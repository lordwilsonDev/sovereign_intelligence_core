# First Contact Demo — 2026-07-23

- started_at: 2026-07-24T04:42:30.298609+00:00
- finished_at: 2026-07-24T04:42:49.668658+00:00
...
- `health` `GET /health` → `200`
  - body: {"status":"ok","runtime":{"state":"running","uptime_seconds":882.9510650634766},"contracts":{"registered":8,"names":["lifecycle","events","kb4","moie","ouroboros","merkle","resources","circuit_breaker"]}}
- `systems_health_status` `GET /systems-health/status` → `200`
  - body: {"system_readiness":"RED","checks":[{"name":"storage","status":"unhealthy","detail":"Disk 96.2% full","timestamp":"2026-07-24T04:42:30.311686+00:00","duration_ms":0.0076249707490205765},{"name":"cpu","status":"healthy","
...
- `agi_harness` `POST /agi-harness/start` → `None`
  - body: timed out