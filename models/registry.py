...
default_registry.register(RegisteredModel("gemma4:31b", "ollama", ModelCapabilities(reasoning=True, extraction=True, classification=True, coding=True, cost_per_1k_tokens=0.0), max_tokens=8192, fallback="deepseek", enabled=False))
default_registry.register(RegisteredModel("qwen3:latest", "ollama", ModelCapabilities(reasoning=True, classification=True, cost_per_1k_tokens=0.0), max_tokens=8192, fallback="qwen2.5:7b-instruct", enabled=False))
