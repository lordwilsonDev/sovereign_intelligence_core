...
test:
	...
	PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=/Users/lordwilson/msb-v2 /opt/homebrew/Caskroom/miniforge/base/bin/python scripts/verify_anonymous_routes.py
